...
export function Feature_products() {
  ...
  return (
    <>
                ...
                <div className="p-1 relative">
                  <Card className="pt-0 group relative overflow-hidden">
                    <CardContent className="flex flex-col p-0">
                      ...
                      {/* Card image — first image from array */}
      ...
      {modalProduct && (
        ...
        >
          <div
            className={`relative bg-white rounded-xl overflow-hidden w-full max-w-3xl flex flex-col sm:flex-row shadow-2xl max-h-[85vh] ${isClosing ? "animate-flip-out" : "animate-flip-in"}`}
